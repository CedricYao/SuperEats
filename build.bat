...
powershell.exe -NoProfile -ExecutionPolicy bypass -Command "& {invoke-psake .\default.ps1 %1 -parameters @{"project_name"="'SuperEats'";"assemblyVersion"="'%assemblyVersion%'"}; exit !($psake.build_success) }"